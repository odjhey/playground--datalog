...
declare module "datascript" {
  ...
  export function from_serializable(source: any): DatascriptDB;
  ...
  export function serializable(db: DatascriptDB): any;
  export const q: <T>(
    query: DatascriptQuery<T> | string,
    db: DatascriptDB,
    ...args: SimpleValue[]
  ) => Array<T>;
  ...
  export const filter: (
    db: DatascriptDB,
    cb: (db: DatascriptDB, d: Datum) => boolean
  ) => DatascriptDB;
